...
def header_creation(saved_directory, model_path, database_path, image_path=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-dir", "--image_directory", type=str, required=False, help="Path to the images directory")
    parser.add_argument("-M", "--model_path", type=str, required=True, help="Path to the model")
    parser.add_argument("-Db", "--database_path", type=str, required=True, help="Path to the database")
    ...
    header_creation(args.image_directory, args.model_path, args.database_path, args.image_path)
