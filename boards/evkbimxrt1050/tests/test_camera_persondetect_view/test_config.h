...
#define SRC_IMAGE_FORMAT SRC_IMAGE_COUPLE_COCO_160_128_RGB565_FORMAT
#define SRC_IMAGE_CHANNELS_NUMBER SRC_IMAGE_COUPLE_COCO_160_128_RGB565_CHANNELS_NUMBER
#define SRC_IMAGE_HEIGHT SRC_IMAGE_COUPLE_COCO_160_128_RGB565_HEIGHT
#define SRC_IMAGE_WIDTH SRC_IMAGE_COUPLE_COCO_160_128_RGB565_WIDTH
void *image_data = (void *)couple_COCO_160_128_rgb565_data;
...
#define EXPECTED_NUM_DETECTED_PERSONS 2
#define EXPECTED_CHECKSUM             0xb2e02ea6
#endif
#else
