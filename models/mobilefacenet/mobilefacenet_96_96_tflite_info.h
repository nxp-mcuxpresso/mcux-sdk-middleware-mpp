...
/*
 * This file provides information about the TFLite model mobilefacenet.h, such as width, heigth and color format.
   Other parameters include input mean and std, output scale and zero point and recognition threshold.
