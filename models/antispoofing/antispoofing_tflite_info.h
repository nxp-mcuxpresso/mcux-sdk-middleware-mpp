...
#ifndef _ANTISPOOFING_TFLITE_INFO_H_
#define _ANTISPOOFING_TFLITE_INFO_H_
 ...
 * The antispoofing data should be between -1 and 1. */
...
#endif /* _ANTISPOOFING_TFLITE_INFO_H_ */
