...
#define SRC_IMAGE_FORMAT SRC_IMAGE_THISPERSONDOESNOTEXIST_11_BGRA_FORMAT
#define SRC_IMAGE_CHANNELS_NUMBER SRC_IMAGE_THISPERSONDOESNOTEXIST_11_BGRA_CHANNELS_NUMBER
#define SRC_IMAGE_HEIGHT SRC_IMAGE_THISPERSONDOESNOTEXIST_11_BGRA_HEIGHT
#define SRC_IMAGE_WIDTH SRC_IMAGE_THISPERSONDOESNOTEXIST_11_BGRA_WIDTH
void *image_data = (void *)thispersondoesnotexist_11_bgra_data;
