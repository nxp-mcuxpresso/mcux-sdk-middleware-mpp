 ...
 *
 **/
#if ((VIEW_WIDTH * HAND_LANDMARK_WIDTH) >= (VIEW_HEIGHT * HAND_LANDMARK_HEIGHT))
#define DETECTION_ZONE_RECT_HEIGHT VIEW_HEIGHT
#define DETECTION_ZONE_RECT_WIDTH  (VIEW_HEIGHT * HAND_LANDMARK_WIDTH / HAND_LANDMARK_HEIGHT)
#else
#define DETECTION_ZONE_RECT_HEIGHT (VIEW_WIDTH * HAND_LANDMARK_HEIGHT / HAND_LANDMARK_WIDTH)
