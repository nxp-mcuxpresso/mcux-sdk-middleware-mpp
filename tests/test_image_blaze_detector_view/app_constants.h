...
#define SRC_IMAGE_FORMAT SRC_IMAGE_HAND_192_192_RGB_FORMAT
#define SRC_IMAGE_CHANNELS_NUMBER SRC_IMAGE_HAND_192_192_RGB_CHANNELS_NUMBER
#define SRC_IMAGE_HEIGHT SRC_IMAGE_HAND_192_192_RGB_HEIGHT
#define SRC_IMAGE_WIDTH SRC_IMAGE_HAND_192_192_RGB_WIDTH
 ...
 *
 **/
#if ((VIEW_WIDTH * BLAZE_DETECTOR_WIDTH) >= (VIEW_HEIGHT * BLAZE_DETECTOR_HEIGHT))
#define DETECTION_ZONE_RECT_HEIGHT VIEW_HEIGHT
#define DETECTION_ZONE_RECT_WIDTH  (VIEW_HEIGHT * BLAZE_DETECTOR_WIDTH / BLAZE_DETECTOR_HEIGHT)
#else
#define DETECTION_ZONE_RECT_HEIGHT (VIEW_WIDTH * BLAZE_DETECTOR_HEIGHT / BLAZE_DETECTOR_WIDTH)
